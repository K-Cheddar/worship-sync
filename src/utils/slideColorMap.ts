...
export const songSectionBgColorMap : Map<string, string> = new Map([
  ['Title', 'bg-stone-500'],
  ['Reprise', 'bg-amber-700'],
...
export const songSectionBorderColorMap : Map<string, string> = new Map([
  ...
  ['Intro', 'border-yellow-700'],
  ['Pre-Chorus', 'border-rose-700'],
  ['Pre-Bridge', 'border-lime-700'],
])
