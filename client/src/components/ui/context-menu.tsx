...
const ContextMenuContent = ({
  ...
  <ContextMenuPortal>
    <ContextMenuPrimitive.Content
      ...
      className={cn(
        "z-50 max-h-[min(24rem,var(--radix-context-menu-content-available-height))] min-w-[12rem] overflow-y-auto overflow-x-hidden rounded-md border border-gray-600 bg-gray-700 p-1 text-white shadow-md",
