...
/**
 * @deprecated Prefer {@link getElectronDisplayWindowKeyFromLocation} so named
 * outputs close the correct Electron window.
 */
export const getElectronDisplayWindowTypeFromPathname = (
  pathname: string,
): WindowType | null => getSurfaceFromPathname(pathname);
