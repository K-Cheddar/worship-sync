  ...
  theme: {
    ...
    extend: {
      padding: {
        px: "1px",
        0: "0",
        0.5: "clamp(0.0625rem,0.125vw,0.15625rem)",
        1: "clamp(0.125rem,0.25vw,0.3125rem)",
        1.5: "clamp(0.1875rem,0.375vw,0.46875rem)",
        2: "clamp(0.25rem,0.5vw,0.625rem)",
        2.5: "clamp(0.3125rem,0.625vw,0.78125rem)",
        3: "clamp(0.375rem,0.75vw,0.9375rem)",
        3.5: "clamp(0.4375rem,0.875vw,1.09375rem)",
        4: "clamp(0.5rem,1vw,1.25rem)",
        5: "clamp(0.625rem,1.25vw,1.5625rem)",
        6: "clamp(0.75rem,1.5vw,1.875rem)",
        7: "clamp(0.875rem,1.75vw,2.1875rem)",
