...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  focusWindow: (windowType: WindowType) =>
    ipcRenderer.invoke("focus-window", windowType),
  toggleWindowFullscreen: (windowType: WindowType) =>
    ipcRenderer.invoke("toggle-window-fullscreen", windowType),
  moveWindowToDisplay: (windowType: WindowType, displayId: number) =>
    ipcRenderer.invoke("move-window-to-display", windowType, displayId),
  ...
  saveLastRoute: (route: string) =>
    ipcRenderer.invoke("save-last-route", route),
